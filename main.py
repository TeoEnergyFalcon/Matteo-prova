        ...
        while True:
            try:
                if self.capture.isOpened() and self.online:
                    ...
                    print("CAPTURE READ 1", self.capture.isOpened(), self.online)
                    status, frame = self.capture.read()
                    print("CAPTURE READ 2")
                    if status:
                    ...
                    print("Exception", self.capture.isOpened(), self.online)
...
if __name__ == '__main__':
    ...
    # Stream links
    camera0 = 'rtsp://192.168.1.169:8554/streamA.h264_aac'.format(username, password)
    camera1 = 'rtsp://192.168.1.168:8554/streamA.h264_aac'.format(username, password)
